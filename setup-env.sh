...
export VITE_APP_SQL_TEMPLATE_ASSISTANT_ENABLED=$(extract_value "$stack_output" SqlTemplateAssistantEnabled)
...
export SQL_TEMPLATE_ASSISTANT_ENABLED=$(extract_value "$stack_output" SqlTemplateAssistantEnabled)
